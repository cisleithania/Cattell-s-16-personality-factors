void w_20_24(int sum_arr[16], int sum_norm[16]) {
	...
	for (int i = 0; i < 16; i++)
	{
		...
		if (i == 2) {
			...
			else if ((sum_arr[i] == 18) || (sum_arr[i] == 19) || (sum_arr[i] == 20)) { sum_norm[i] = 9; }
		...
		if (i == 5) {
			...
			else if ((sum_arr[i] == 8) || (sum_arr[i] == 9) || (sum_arr[i] == 8)) { sum_norm[i] = 3; }
		...
		if (i == 6) {
			...
			else if ((sum_arr[i] == 5) || (sum_arr[i] == 6) || (sum_arr[i] == 7)) { sum_norm[i] = 4; }
			else if ((sum_arr[i] == 8) || (sum_arr[i] == 9) || (sum_arr[i] == 10)) { sum_norm[i] = 5; }
			else if ((sum_arr[i] == 11) || (sum_arr[i] == 12)) { sum_norm[i] = 6; }
			else if ((sum_arr[i] == 13) || (sum_arr[i] == 14) || (sum_arr[i] == 15) || (sum_arr[i] == 16)) { sum_norm[i] = 7; }
