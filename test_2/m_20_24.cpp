void m_20_24(int sum_arr[16], int sum_norm[16]) {
	...
	for (int i = 0; i < 16; i++)
	{
		...
		if (i == 2) {
			...
			else if ((sum_arr[i] == 12) || (sum_arr[i] == 13) || (sum_arr[i] == 14)) { sum_norm[i] = 5; }
		...
		if (i == 4) {
			...
			else if ((sum_arr[i] == 9) || (sum_arr[i] == 10) || (sum_arr[i] == 11)) { sum_norm[i] = 4; }
		...
		if (i == 7) {
			...
			else if (sum_arr[i] == 8) { sum_norm[i] = 5; }
		...
		if (i == 10) {
			...
			else if (sum_arr[i] == 11) { sum_norm[i] = 7; }
			else if ((sum_arr[i] == 12) || (sum_arr[i] == 13)) { sum_norm[i] = 8; }
			else if (sum_arr[i] == 14) { sum_norm[i] = 9; }
